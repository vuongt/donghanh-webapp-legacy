...
//    UNIVERSITY_NAMES.put("CTHO", "Trường đại học Cần Thơ");
    ...
    UNIVERSITY_NAMES.put("THPTVINH", "Trường THPT Vinh");
...
//    FOUNDATION_NAMES.put("CTHO", "học bổng Đồng Hành Đài Loan");
    ...
    FOUNDATION_NAMES.put("THPTVINH", "học bổng Đồng Hành - Nghệ Tĩnh");
...
//    LOGO.put("CTHO", PARAMS.get("LOGO_DH"));
    ...
    LOGO.put("THPTVINH", PARAMS.get("LOGO_DH"));
...
//    NB_JUGES_BY_COPY.put("CTHO", 4);
    ...
    NB_JUGES_BY_COPY.put("THPTVINH", 3);
