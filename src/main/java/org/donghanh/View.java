...
public class View extends HttpServlet {
  ...
  void showCandidateTable(HttpServletRequest request, HttpServletResponse response) throws IOException {
  ...
  void viewDistributions(HttpServletRequest request, HttpServletResponse response) throws IOException {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    if (action != null && action.equals("VIEW_DISTRIBUTIONS")) {
      viewDistributions(request, response);
    }

    if (action != null && action.equals("SHOW_CANDIDATE_TABLE")) {
