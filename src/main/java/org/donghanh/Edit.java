...
public class Edit extends HttpServlet {
    ...
    void normalize(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // HÀM CHUẨN HOÁ
    ...
    void updateFinalResults(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    static void createFinalNotification(String university) throws FileNotFoundException, UnsupportedEncodingException {
    ...
    public void getAllCandidatesFromUniversity(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String university = request.getParameter("university");
    ...
    static void makePdfEvalForms(String university, int index) throws IOException {
    ...
    static void mergePdfs(String university, int nb_files) throws COSVisitorException, IOException {
    ...
    static void mergeAll(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, COSVisitorException {
    ...
    void downloadResultsHtml(HttpServletRequest request, HttpServletResponse response) throws ServletException, MalformedURLException, IOException {
    ...
    void downloadNotifForUniversity(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    static void downloadAllNotifs(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, COSVisitorException {
        Set<String> universities = Parameters.UNIVERSITY_NAMES.keySet();
        PDFMergerUtility ut = new PDFMergerUtility();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (my_action != null && my_action.equals("NORMALIZE")) {
            normalize(request, response);
        }

        if (my_action != null && my_action.equals("UPDATE_FINAL_RESULTS")) {
            updateFinalResults(request, response);
        }

        if (my_action != null && my_action.equals("GET_ALL_CANDIDATES_FROM_UNIVERSITY")) {
        ...
        if (my_action != null && my_action.equals("DOWNLOAD_FORMS")) {
            try {
        ...
        if (my_action != null && my_action.equals("DOWNLOAD_RESULTS_HTML")) {
            downloadResultsHtml(request, response);
        }

        if (my_action != null && my_action.equals("DOWNLOAD_NOTIF_FOR_UNIVERSITY")) {
            downloadNotifForUniversity(request, response);
        }

        if (my_action != null && my_action.equals("DOWNLOAD_ALL_NOTIFS")) {
            try {
