...
class LocalFunctions {
  ...
  static int nbJuges(int nb_docs, int nb_juges_by_copy, int max_docs, String evaluated_by) {
    if (evaluated_by.equals("FR")) {
      return max_docs; // TODO rename this variable to nb of judges
      ...
      if (nb_docs <= 0) {
        ...
        return max_docs * nb_juges_by_copy;
      }
    } else {
      return 0;
    }
  ...
  static String[] Distribution(int numTotalCandidates, int numJuriesPerCopy, int max_docs, String evaluated_by) {
